...
public class NewJingLogger {
    ...
    public void output(JingLoggerLevel level, String msg) {
        ...
        for (String outputPath : level.levelConfig.loggerPathSet) {
            writer = JingLoggerConfiguration.writerMap.get(outputPath);
            try {
                if (null != writer && writer.getFD().valid()) {
                    writer.write(content.getBytes(level.levelConfig.encoding));
                    writer.flush();
                }
            }
    ...
    public static void main(String[] args) {
        ...
        NewJingLogger logger = NewJingLogger.getLogger(JingLoggerLevel.class);
